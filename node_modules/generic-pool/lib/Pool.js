...
class Pool extends EventEmitter {
  ...
  constructor(Evictor, Deque, PriorityQueue, factory, options) {
    ...
    /**
     * Loan keyed by the borrowed resource
     * @type {Map}
     */
    this._resourceLoan = new Map();
  ...
  _dispatchPooledResourceToNextWaitingClient(pooledResource) {
    ...
    this._resourceLoan.set(pooledResource.obj, loan);
  ...
  isBorrowedResource(resource) {
    return this._resourceLoan.get(resource) !== undefined;
  }
  ...
  release(resource) {
    ...
    const loan = this._resourceLoan.get(resource);
    ...
    this._resourceLoan.delete(resource);
    loan.resolve();
  ...
  __allResourcesReturned() {
    const ps = Array.from(this._resourceLoan.values())
   ...
   */
  get borrowed() {
    return this._resourceLoan.size;
  }
